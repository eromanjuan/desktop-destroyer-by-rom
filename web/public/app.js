...
const WEAPONS = [
  ...
  { key:'8', ico:'local_gas_station', name:'Gasoline', use:'Drag to pour',
  ...
  { key:'9', ico:'local_fire_department', name:'Flamethrower', use:'Hold and drag',
    text:'A continuous jet of fire that burns the screen to black char — and sets light to any gasoline or stuck arrows it sweeps across.' },
  { key:'0', ico:'crisis_alert', name:'Nuke Strike', use:'Lock targets · right-click launch',
  ...
  { key:'—', ico:'brush', name:'Paintbrush',   use:'Drag to paint',
    text:'For when you would rather deface than destroy. The colour shifts through the rainbow as you drag.' },
  { key:'R', ico:'cleaning_services', name:'Washer',       use:'Scrub, or press R',
